...
class ScanExperiment(ScanExperimentForm, MainWindowWidget.MainWindowWidget):
    ...
    def setupUi(self, MainWindow, config):
        ...
        if self.experimentName+'.plotNames' in self.config:
            ...
            #plotNames = copy(self.requiredPlotNames)     # if we are starting a new project we need to change to plotNames = copy.deepcopy(self.requiredPlotNames)
            plotNames = copy.deepcopy(self.requiredPlotNames)

...
class plotNScan(ExpFragment):
    ...
    def run_once(self):
        ...
        for rid in lst_rids:
            ...
            key_name_y = "ndscan.rid_" + rid + ".points.channel_counts"  # key name for result parameter points
            ...
            plt.scatter(x_vals_1, y_vals_1, marker='x')
        ...
        plt.xlabel(key_name_x)
        plt.ylabel(key_name_y)

...
class AmplitudeRampZotino(EnvExperiment):
    def build(self):
        ...
        self.setattr_argument("ramp_rate", NumberValue(default=0.0005, ndecimals=6), tooltip="Urukul0Ch0")
        ...
        self.setattr_argument("zotino_target", NumberValue(default=0, min=0, max=4.2, ndecimals=6), tooltip="Urukul0Ch0")

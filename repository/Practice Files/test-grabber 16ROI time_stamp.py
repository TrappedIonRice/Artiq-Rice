...
class Simple66(EnvExperiment):
    ...
    def run_kernel(self):       
        ...
        self.grabber0.setup_roi(0, 10,  5, 16, 11)
        self.grabber0.setup_roi(1, 28, 5, 34, 11)
        self.grabber0.setup_roi(2, 46, 5, 52, 11)
        self.grabber0.setup_roi(3, 64, 5, 70, 11)
        self.grabber0.setup_roi(4, 82, 5, 88, 11)
        self.grabber0.setup_roi(5, 100, 5, 106, 11)
        self.grabber0.setup_roi(6, 118, 5, 124, 11)
        self.grabber0.setup_roi(7, 136, 5, 142, 11)
        self.grabber0.setup_roi(8, 154, 5, 160, 11)
        self.grabber0.setup_roi(9, 172, 5, 178, 11)
        self.grabber0.setup_roi(10, 190, 5, 196, 11)
        self.grabber0.setup_roi(11, 208, 5, 214, 11)
        self.grabber0.setup_roi(12, 226, 5, 232, 11)
        self.grabber0.setup_roi(13, 244, 5, 250, 11)
        self.grabber0.setup_roi(14, 262, 5, 268, 11)
        self.grabber0.setup_roi(15, 280, 5, 286, 11)
        ...
        falling_gate_dynamic = measured_width_s 
        ...
        while captured_count < self.target_count:
            ...
            # 3. wait for the falling edge with dynamic gate
